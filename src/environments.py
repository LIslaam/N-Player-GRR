...
def super_sym(gamma=0.99, fixed_defect=-3.0): # Fixed defect: We fix the strategy if our
                                                        #opponent defects, to defect with high probability
  dims = [1, 1, 1] 
  payout_mat_1 = jnp.array([[[1,-1],[-1,1], [1,-1],[-1,1]]]) # 3D tensor
  payout_mat_2 = jnp.array([[[-1,1],[1,-1]], [[-1,1],[1,-1]]])
  payout_mat_3 = jnp.array([[[0,0],[0,0]], [[0,0],[0,0]]]) # 3 players, 3 matrices
